...
export default function MediaPage() {
  const locale = 'en' // Default fallback for non-locale route
  
  // Simple translation fallback for non-locale route
  const t = (key: string) => {
    const translations: Record<string, string> = {
      'media.mediaLibrary': 'Media Library',
      'media.manageImagesVideos': 'Manage your images and videos',
      'media.uploadFiles': 'Upload Files',
      'media.addOnlineVideo': 'Add Online Video',
      ...
      'media.bilibili': 'Bilibili',
      'media.selectMedia': 'Media Details',
      'status.noOnlineVideosFound': 'No online videos found',
      'status.noMediaFound': 'No media files found',
      'status.tryAdjustingSearch': 'Try adjusting your search terms',
      'status.addVideosToGetStarted': 'Add some online videos to get started',
      'status.addFilesToGetStarted': 'Upload some files to get started',
      ...
      'common.updateAltText': 'Update Alt Text',
      'placeholder.describeImage': 'Describe this image...'
    }
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="upload" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="online">Add Online Video</TabsTrigger>
        </TabsList>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">
            No {selectedType === 'online' ? 'online videos' : 'media files'} found
          </h3>
          <p className="text-gray-500">
            {searchTerm ? 'Try adjusting your search terms' : selectedType === 'online' ? 'Add some online videos to get started' : 'Upload some files to get started'}
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              <div className="space-y-4">
                <div className="aspect-square bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
                  {selectedMedia.media_type === 'image' ? (
                    <img
                      src={`http://localhost:8080/api${selectedMedia.url}`}
                ...
                <div className="text-center">
                  <Button
                    variant="outline"
                    onClick={() => {
                      const url = `http://localhost:8080/api${selectedMedia.url}`
